...
namespace kat {
    ...
    inline char getCharFromEvent(const sf::Event& e, bool is_shift) {
    ...
    inline std::pair<float, float> normalizeSize(const std::string& data, const std::vector<float>& paddings,
